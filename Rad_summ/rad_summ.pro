...
readcol,"/proj/rac/ops/ACE/fluace.dat.good",ace,format="a",delimiter="ZZZ"
;readcol,"/export/acis-flight/FLU-MON/current.dat",acis,format="a",delimiter="ZZZ"
readcol,"./current.dat",acis,format="a",delimiter="ZZZ"
...
printf, OUT, '<br /><br />'
printf, OUT, '<img src="/mta/RADIATION/CRM3/crmplatt.gif">'
