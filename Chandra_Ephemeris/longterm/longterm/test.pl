...
#@efile = ('/dsops/GOT/aux/DEPH.dir/DE15306.EPH');
@efile = ('/dsops/GOT/aux/DEPH.dir/DE14349.EPH');
...
#
    ...
    open (OF, ">./zzz") or die "Cannot open output ephemeris file $of\n";
...
#        print "TIME: $ephem_step_time\n";
#        foreach $ent (@ephem_pos_vel_data_1_50){
#            print "$ent\n";
#        }
#        exit 1;
	    $year = int($ephem_date/1e4);
	    ...
	    for $i (0..49) {
            ...
            print "I AM HERE: $vec[$i*6] <----> $bad_data\n";
