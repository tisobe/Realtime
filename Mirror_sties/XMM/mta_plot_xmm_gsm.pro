...
;
;  updated by t. isobe (tisobe@cfa.harvard.edu) Nov 04, 2015
;-----------------------------------------------------------------
...
;--- read XMM orbit
;
xmmfile = "/data/mta_www/MIRROR/OPS/ephem/TLE/xmm.spctrk"
...
;--- read CXO orbit
;
cxofile = "/data/mta_www/MIRROR/OPS/ephem/TLE/cxo.spctrk"
...
vz    = vz(b)
;
;--- sekectubg time period for CXO --- +/- 1.35 days
;
...
write_gif,'/data/mta_www/MIRROR/RADIATION/XMM/mta_xmm_plot_gsm.gif',tvrd()
print, "check here"
...
write_gif,"/data/mta_www/MIRROR/RADIATION/XMM/time_x.gif",tvrd()
...
write_gif,"/data/mta_www/MIRROR/RADIATION/XMM/time_y.gif",tvrd()
...
write_gif,"/data/mta_www/MIRROR/RADIATION/XMM/time_z.gif",tvrd()
